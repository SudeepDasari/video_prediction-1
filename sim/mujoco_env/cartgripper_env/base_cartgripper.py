from sim.mujoco_env.base_mujoco_env import BaseMujocoEnv
import numpy as np
import sim
from sim.mujoco_env.util.create_xml import create_object_xml, create_root_xml, clean_xml
import copy
from pyquaternion import Quaternion
import pdb


BASE_DIR = '/'.join(str.split(sim.__file__, '/')[:-1])
asset_base_path = BASE_DIR + '/cartgripper_assets/'
